...
1. `Add-Migration -StartupProject BillingService -Project BillingService.Backend.Database -Context DatabaseContext -OutputDir Migrations <name>`
1. `Update-Database -StartupProject BillingService -Project BillingService.Backend.Database -Context DatabaseContext`

To remove migration:

1. `Remove-Migration -StartupProject BillingService -Project BillingService.Backend.Database -Context DatabaseContext`
